...
Error vmcall_external(CPU* cpu, Memory* mem)
{
    ...
    MemoryAddr addr = mem->stack[cpu->registers.SS.as_u64 - 1].as_u64;

    if (addr >= MEMORY_CAPACITY) {
        return ERR_ILLEGAL_MEMORY_ACCESS;
    }

    mem->stack[cpu->registers.SS.as_u64 - 1].as_ptr = &mem->memory[addr];
...
Error vmcall_write(CPU* cpu, Memory* mem)
{
    ...
    MemoryAddr addr = mem->stack[cpu->registers.SS.as_u64 - 2].as_u64;
    uint64_t count = mem->stack[cpu->registers.SS.as_u64 - 1].as_u64;
...
Error vmcall_alloc(CPU* cpu, Memory* mem)
{
    ...
    mem->stack[cpu->registers.SS.as_u64 - 1].as_ptr = malloc(mem->stack[cpu->registers.SS.as_u64 - 1].as_u64);
...
Error vmcall_free(CPU* cpu, Memory* mem)
{
    ...
    free(mem->stack[cpu->registers.SS.as_u64 - 1].as_ptr);
...
Error vmcall_print_f64(CPU* cpu, Memory* mem)
{
    ...
    printf("%lf\n", mem->stack[cpu->registers.SS.as_u64 - 1].as_f64);
    cpu->registers.SS.as_u64 -= 1;
    return ERR_OK;
}
...
Error vmcall_print_i64(CPU* cpu, Memory* mem)
{
    ...
    printf("%" PRId64 "\n", mem->stack[cpu->registers.SS.as_u64 - 1].as_i64);
    cpu->registers.SS.as_u64 -= 1;
    return ERR_OK;
}
...
Error vmcall_print_u64(CPU* cpu, Memory* mem)
{
    ...
    printf("%" PRIu64 "\n", mem->stack[cpu->registers.SS.as_u64 - 1].as_u64);
    cpu->registers.SS.as_u64 -= 1;
    return ERR_OK;
}
...
Error vmcall_print_ptr(CPU* cpu, Memory* mem)
{
    ...
    printf("%p\n", mem->stack[cpu->registers.SS.as_u64 - 1].as_ptr);
    cpu->registers.SS.as_u64 -= 1;
    return ERR_OK;
}
...
Error vmcall_set_color(CPU* cpu, Memory* mem)
{
    ...
    uint64_t color = mem->stack[cpu->registers.SS.as_u64 - 1].as_u64;
